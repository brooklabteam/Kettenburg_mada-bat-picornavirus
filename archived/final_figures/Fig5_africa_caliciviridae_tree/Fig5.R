...
#          "Nacovirus"="thistle3", "Nebovirus"="darkorchid2", "sapovirus"="sienna", "Unclassified"="darkorchid4")

#pick order for the labels
dat$Genus <- factor(dat$Genus, levels = c("Sapovirus" ,  "Vesivirus",   "Lagovirus",   "Norovirus",   "Calicivirus",
                                          "Salovirus",    "Bavovirus",  "Minovirus",  "Recovirus", "Nacovirus", "Nebovirus", "sapovirus" ,"Unclassified", 
                                          "Coronavirus"))   
