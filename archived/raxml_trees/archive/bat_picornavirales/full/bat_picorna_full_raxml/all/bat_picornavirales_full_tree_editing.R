...
##Picornavirales full refseq bat sequences with only full novel sequences, genome wide alignment
setwd(paste0(homewd,"/raxml_trees/bat_picornavirales/full/bat_picorna_full_raxml/all"))
...
dat <- read.csv(("bat_picornavirales_full_metadata.csv"), header = T, stringsAsFactors = F)
head(dat)
...
#tree is small enough that I will not collapse

#export 10x7 inch portrait PDF
