...
sapo_map_nt1 <- ggplot(long.sim_nt) + geom_line(aes(x=pointer, y=value, color=accession), size=1) +
  theme(panel.background = element_rect("white"),
        panel.border = element_rect(linetype = "solid", fill=NA)) + ylab("% Bootstrap support")+xlab("Genome position")+
  theme(panel.grid = element_blank(), strip.text = element_text(face="italic", size=12),
        strip.background = element_rect(fill="white"), 
...
#put gene map with bootscan
sapo_nt1<-sapo_map_nt1/map_sapo+plot_layout(nrow=2,  heights = c(1, 0.2))
sapo_nt1

sapo_nt1<-as.ggplot(sapo_nt1)
sapo_nt1
...
sapo_map_nt2 <- ggplot(long.sim_nt) + geom_line(aes(x=pointer, y=value, color=accession), size=1) +
  theme(panel.background = element_rect("white"),
        panel.border = element_rect(linetype = "solid", fill=NA)) + ylab("% Bootstrap support")+xlab("Genome position")+
  theme(panel.grid = element_blank(), strip.text = element_text(face="italic", size=12),
        strip.background = element_rect(fill="white"), 
...
#put gene map with bootscan
sapo_nt2<-sapo_map_nt2/map_sapo+plot_layout(nrow=2,  heights = c(1, 0.2))
sapo_nt2

sapo_nt<-as.ggplot(sapo_nt2)
sapo_nt2
...
rdp<-plot_grid(hepato_clade_nt, hepato_nt, sapelo_clade_nt1, sapelo_clade_nt2, sapo_nt1,
               sapo_nt2, tescho_clade_nt1, tescho_clade_nt2, tescho_nt1,
                      ncol=3,
