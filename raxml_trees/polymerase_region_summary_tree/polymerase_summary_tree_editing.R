...
p2 <- ggtree(rooted.tree) %<+% tree.dat + geom_tippoint(aes(color=Genus, shape=Host), size=4,stroke=0,show.legend = T) +
  ...
  theme(legend.position = "none", 
        ...
        legend.key.size = unit(0.3, "cm")) +
  xlim(c(0,7))+
  geom_cladelabel(node = 477, label = "Pig sapovirus",offset=0.05, fontsize=4, color="black") +
  geom_cladelabel(node = 449, label = "Pig sapovirus", offset=0.05,fontsize=4, color="black") +
  geom_cladelabel(node = 398, label = "Human sapovirus", offset=0.05, fontsize=4, color="black")+ 
  geom_cladelabel(node = 329, label = "Kobuvirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 324, label = "Kobuvirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 353, label = "Cardiovirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 383, label = "Porcine teschovirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 530, label = "Shanbavirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 540, label = "Hepatovirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 506, label = "Sapelovirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 520, label = "Sapelovirus", offset=0.05,fontsize=4, color="black")+
  geom_cladelabel(node = 294, label = "Kobuvirus", offset=0.05,fontsize=4, color="black")
p2

#collapse the labeled clades
p3<-collapse(p2, 477)+geom_point2(aes(subset=(node==477)), size=4, shape=22, fill="white")
p4<-collapse(p3, 449)+geom_point2(aes(subset=(node==449)), size=4, shape=22, fill="white")
p5<-collapse(p4, 398)+geom_point2(aes(subset=(node==398)), size=4, shape=22, fill="white")
p6<-collapse(p5, 329)+geom_point2(aes(subset=(node==329)), size=4, shape=22, fill="white")
p8<-collapse(p6, 324)+geom_point2(aes(subset=(node==324)), size=4, shape=22, fill="white")
p9<-collapse(p8, 353)+geom_point2(aes(subset=(node==353)), size=4, shape=22, fill="white")
p10<-collapse(p9, 383)+geom_point2(aes(subset=(node==383)), size=4, shape=22, fill="white")
p11<-collapse(p10, 530)+geom_point2(aes(subset=(node==530)), size=4, shape=22, fill="white")
p12<-collapse(p11, 540)+geom_point2(aes(subset=(node==540)), size=4, shape=22, fill="white")
p13<-collapse(p12, 506)+geom_point2(aes(subset=(node==506)), size=4, shape=22, fill="white")
p14.1<-collapse(p13, 520)+geom_point2(aes(subset=(node==520)), size=4, shape=22, fill="white")
p14<-collapse(p14.1, 294)+geom_point2(aes(subset=(node==294)), size=4, shape=22, fill="white")
p14
