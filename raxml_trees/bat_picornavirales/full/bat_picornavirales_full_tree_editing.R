...
setwd(paste0(homewd,"/raxml_trees/bat_picornavirales/full"))
...
dat <- read.csv(("bat_picornavirales_full.csv"), header = T, stringsAsFactors = F)
head(dat)
...
#I will not be collapsing this tree
