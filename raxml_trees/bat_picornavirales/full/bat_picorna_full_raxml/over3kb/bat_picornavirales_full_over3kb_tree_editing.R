...
##Picornavirales full refseq bat sequences over 3kb, all novel sequences in picornaviridae and caliciviridae over 3kb
setwd(paste0(homewd,"/raxml_trees/bat_picornavirales/full/bat_picorna_full_raxml/over3kb"))
...
dat <- read.csv(("bat_picornavirales_full_over3kb_metadata.csv"), header = T, stringsAsFactors = F)
head(dat)
