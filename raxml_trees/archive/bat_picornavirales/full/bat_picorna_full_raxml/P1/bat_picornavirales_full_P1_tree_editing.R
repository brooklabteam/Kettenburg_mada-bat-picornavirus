...
##Picornavirales full refseq bat sequences with alignment centered around P1 region
setwd(paste0(homewd,"/raxml_trees/bat_picornavirales/full/bat_picorna_full_raxml/P1"))
...
dat <- read.csv(("bat_picornavirales_full_P1_metadata.csv"), header = T, stringsAsFactors = F)
head(dat)
...
#since tree is small I will not collapse it

#export 10x7 inch PDF portrait
